                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="{{ asset('assets') }}/img/-fluid" src="{{ asset('assets') }}/img/blog/blog1.png"
                                    alt="">
                                <ul class="thumb-info">
                        ...
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="{{ asset('assets') }}/img/-fluid" src="{{ asset('assets') }}/img/blog/blog2.png"
                                    alt="">
                                <ul class="thumb-info">
                                    <li><a href="#"><i class="ti-user"></i>Admin</a></li>
                                    <li><a href="#"><i class="ti-notepad"></i>January 12,2019</a></li>
                        ...
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="{{ asset('assets') }}/img/-fluid"
                                    src="{{ asset('assets') }}/img/blog/blog3.png" alt="">
                                <ul class="thumb-info">
                                    <li><a href="#"><i class="ti-user"></i>Admin</a></li>
                                    <li><a href="#"><i class="ti-notepad"></i>January 12,2019</a></li>
                                    <li><a href="#"><i class="ti-themify-favicon"></i>2 Comments</a></li>
                        ...
                        <div class="single-recent-blog-post">
                            <div class="thumb">
                                <img class="{{ asset('assets') }}/img/-fluid"
                                    src="{{ asset('assets') }}/img/blog/blog4.png" alt="">
                                <ul class="thumb-info">
                                    <li><a href="#"><i class="ti-user"></i>Admin</a></li>
                                    <li><a href="#"><i class="ti-notepad"></i>January 12,2019</a></li>
                                    <li><a href="#"><i class="ti-themify-favicon"></i>2 Comments</a></li>
